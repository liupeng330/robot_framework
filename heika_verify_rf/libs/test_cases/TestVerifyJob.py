...
class TestSystemApprovedJob:
    ...
    def __init__(self):
        ...
        self.base_url = 'http://172.16.2.38:15081'
        self.executor_id = 69;
        self.channel_id = 25;
    ...
    def test_for_application_user_init_job(self):
        ...
        response = self.request.load_application_status(response.application_id)
        helper.log('检查进件审核状态')
        tools.eq_(response.result_code, 'OK')
        ...
        tools.eq_(response.credit_limit, 20000.0)
    ...
    def _prepare_test_data(self, user_info):
        ...
        utils.update_user_bank_card_info_by_user_key(self.user_key, user_info.bank_number, user_info.bank_name, user_info.real_name, user_info.id_number)
